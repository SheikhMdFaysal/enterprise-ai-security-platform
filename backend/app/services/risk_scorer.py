    ...
    COMPLIANCE_MAPPINGS = {
        "SOC2": {
            ...
            "privilege_escalation": {
                "controls": ["CC6.1", "CC6.3", "CC6.6"],
                "description": "Role-based access controls bypassed or escalated",
                "remediation": "Enforce strict role-based access controls and privilege separation"
            }
        },
        "ISO27001": {
            "cross_user": {
            ...
            "privilege_escalation": {
                ...
                "description": "Privilege management and access control failure",
                "remediation": "Implement strict privilege management and review procedures"
            }
        },
        "CPCSC": {
            "cross_user": {
            ...
            "privilege_escalation": {
                "controls": ["AC-5", "AC-6", "AC-6(1)"],
                "description": "Separation of duties and least privilege violation",
                "remediation": "Enforce least privilege and separation of duties controls"
            }
        },
        "NIST_AI_RMF": {
            "cross_user": {
            ...
            "privilege_escalation": {
                "controls": ["GOVERN-1.2", "GOVERN-6.1", "MANAGE-2.4"],
                "description": "AI system access control and governance failure",
                "remediation": "Implement robust AI access governance and monitoring"
            }
        },
        "GDPR": {
            "cross_user": {
                "controls": ["Article 25", "Article 32"],
                "description": "Data protection by design and security of processing failure",
                "remediation": "Implement data protection by design and appropriate technical measures"
            },
            "training_data": {
                "controls": ["Article 25", "Article 35"],
                "description": "Data protection by design and impact assessment failure",
                "remediation": "Conduct data protection impact assessment and implement safeguards"
            },
            "context_boundary": {
                "controls": ["Article 25", "Article 32"],
                "description": "Insufficient technical measures for data separation",
                "remediation": "Implement appropriate technical and organizational measures for data isolation"
            },
            "system_prompt": {
                "controls": ["Article 25", "Article 32"],
                "description": "System configuration exposure violates security of processing",
                "remediation": "Ensure security of processing through appropriate technical measures"
            },
            "privilege_escalation": {
                "controls": ["Article 25", "Article 32", "Article 35"],
                "description": "Access control failure violates data protection by design principles",
                "remediation": "Implement robust access controls and conduct impact assessment"
            },
            "pii_leakage": {
                "controls": ["Article 25", "Article 32", "Article 35"],
                "description": "Personal data protection failure",
                "remediation": "Implement appropriate safeguards for personal data processing"
            }
        },
        "CCPA": {
            "cross_user": {
                "controls": ["Section 1798.100", "Section 1798.150"],
                "description": "Unauthorized disclosure of consumer personal information",
                "remediation": "Implement reasonable security procedures to protect consumer data"
            },
            "training_data": {
                "controls": ["Section 1798.100", "Section 1798.150"],
                "description": "Improper collection or use of consumer personal information",
                "remediation": "Ensure proper disclosure and consent for data usage"
            },
            "context_boundary": {
                "controls": ["Section 1798.100", "Section 1798.150"],
                "description": "Cross-boundary data access violates consumer data protection",
                "remediation": "Implement strict data boundary controls for consumer information"
            },
            "system_prompt": {
                "controls": ["Section 1798.100"],
                "description": "System configuration exposure may reveal data handling practices",
                "remediation": "Protect system configuration and data handling procedures"
            },
            "privilege_escalation": {
                "controls": ["Section 1798.100", "Section 1798.150"],
                "description": "Access control bypass risks unauthorized access to consumer data",
                "remediation": "Implement and maintain reasonable security procedures and practices"
            },
            "pii_leakage": {
                "controls": ["Section 1798.100", "Section 1798.150"],
                "description": "Unauthorized disclosure of consumer personal information",
                "remediation": "Implement reasonable security measures to prevent data breaches"
            }
        }
    }
